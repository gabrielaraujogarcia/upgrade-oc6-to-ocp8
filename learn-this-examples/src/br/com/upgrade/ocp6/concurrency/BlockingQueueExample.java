...
public class BlockingQueueExample {
	...
	private static void addElements() {
		...
		try {
			...
			System.out.println("Can`t add null to BlockingQueue");
		}
	...
	private static void retrievesElements() {
		...
		queue.remove();
		System.out.println("Using remove() to remove an item then using peek() to show the head: " + queue.peek());
		checkQueue(queue, "Tip: peek() don't removes an element from queue");
	...
	/**
	 * Runnable que adiciona elementos a BlockingQueue enquanto a capacidade maxima nao for 
	 * atingida
	 * @author Gabriel
	 *
	 */
